(function(window, document) {
    ...
    function setSession(token, user, eventName) {
        ...
        window.dispatchEvent(new CustomEvent('miaosite-auth-change', { detail: { user: user } }));
    }
    ...
    function clearSession(reason) {
        ...
        window.dispatchEvent(new CustomEvent('miaosite-auth-change', { detail: { user: null } }));
    }
    ...
    function bindEvents() {
        document.addEventListener('click', function(event) {
            ...
            if (target.id === 'btn-user' || (target.closest && target.closest('#btn-user'))) {
                ...
                else if (typeof window.__miaositeOpenAuth === 'function') return; // React handles this
                else showAuth('login');
            }
